...
(function () {
  ...
  style.textContent = [
    ...
    '#bp-bubble { width: 54px; height: 54px; border-radius: 50%; background: '+COLOR+'; display: flex; align-items: center; justify-content: center; cursor: pointer; box-shadow: 0 4px 16px rgba(0,0,0,0.18); border: none; transition: transform 0.2s; }',
    ...
    '#bp-header { background: '+COLOR+'; padding: 12px 14px; display: flex; align-items: center; gap: 10px; }',
    ...
    '.bp-hclose { margin-left: auto; cursor: pointer; background: none; border: none; color: white; opacity: 0.7; font-size: 20px; line-height: 1; }',
    ...
    '.bp-choice { font-size: 11px; padding: 5px 11px; border-radius: 20px; border: 0.5px solid '+COLOR+'; color: '+COLOR+'; background: transparent; cursor: pointer; }',
    '.bp-choice:hover { background: '+colorLight+'; }',
    ...
    '#bp-send { padding: 7px 10px; background: '+COLOR+'; border: none; border-radius: 6px; cursor: pointer; color: white; font-size: 16px; }',
    ...
    '.bp-cal-nav { background: none; border: none; cursor: pointer; color: #9E9D99; font-size: 16px; padding: 2px 5px; }',
    ...
    '.bp-day { width: 100%; aspect-ratio: 1; display: flex; align-items: center; justify-content: center; border-radius: 50%; cursor: pointer; font-size: 11px; border: none; background: none; }',
    ...
    '.bp-slot { font-size: 11px; padding: 6px 4px; border-radius: 6px; border: 0.5px solid #E5E4E0; background: white; cursor: pointer; text-align: center; }',
    ...
    '.bp-mybooking { background: #F8F7F4; border-radius: 8px; padding: 10px 12px; margin: 0 12px 6px; border-left: 3px solid '+COLOR+'; }',
