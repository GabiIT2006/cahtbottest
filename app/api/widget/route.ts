...
(function () {
  ...
  style.textContent = [
    ...
    '#bp-header { background: '+COLOR+'; padding: 14px 14px; display: flex; align-items: center; gap: 12px; }',
    '.bp-hav { width: 34px; height: 34px; border-radius: 50%; background: rgba(255,255,255,0.2); display: flex; align-items: center; justify-content: center; flex-shrink: 0; margin-right: 2px; }',
    '.bp-hav svg { width: 20px; height: 20px; fill: white; }',
    '.bp-hname { font-size: 14px; font-weight: 600; color: white; letter-spacing: 0.01em; }',
    ...
    '.bp-msg { max-width: 80%; font-size: 13px; line-height: 1.6; padding: 10px 14px; border-radius: 14px; word-wrap: break-word; }',
